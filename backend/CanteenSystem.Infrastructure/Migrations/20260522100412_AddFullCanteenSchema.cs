...
{
    /// <inheritdoc />
    public partial class AddFullCanteenSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .OldAnnotation("Npgsql:Enum:user_role", "user,admin,super_admin");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Token = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GatewayTxnId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyMenus_MenuDate_MenuItemId_MealSlot",
                table: "DailyMenus",
                columns: new[] { "MenuDate", "MenuItemId", "MealSlot" },
                unique: true);
